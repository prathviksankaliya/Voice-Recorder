...
class RecorderService {
  ...
  Future<void> startRecording() async {
    try {
      ...
      // Configure recording settings with proper audio session handling
      const config = RecordConfig(
        androidConfig: AndroidRecordConfig(
          audioSource: AndroidAudioSource.mic,  // Changed to voice for better interruption handling
          useLegacy: true,  // Use newer audio APIs for better interruption support
          muteAudio: false,
          service: AndroidService(
            title: 'Recording in progress',
            content: 'Your microphone is active and audio is being recorded.',
          ),
        ),
        ...
        autoGain: true, // Enable automatic gain control for voice
